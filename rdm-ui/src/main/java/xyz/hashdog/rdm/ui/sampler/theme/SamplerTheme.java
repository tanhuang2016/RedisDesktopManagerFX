...
import xyz.hashdog.rdm.ui.sampler.FileResource;
...
import static xyz.hashdog.rdm.ui.sampler.theme.ThemeManager.APP_STYLESHEETS;
import static xyz.hashdog.rdm.ui.sampler.theme.ThemeManager.PROJECT_THEMES;
...
public final class SamplerTheme implements Theme {
    ...
    private static final Pattern COLOR_PATTERN =
        Pattern.compile("\s*?(-color-(fg|bg|accent|success|danger|warning|border|base)-.+?):\s*?(.+?);");
