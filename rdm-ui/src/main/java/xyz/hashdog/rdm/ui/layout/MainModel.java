...
package xyz.hashdog.rdm.ui.layout;
...
import xyz.hashdog.rdm.ui.event.DefaultEventBus;
import xyz.hashdog.rdm.ui.event.NavEvent;
...
public class MainModel {
    ...
    // ~
    private final ReadOnlyObjectWrapper<SubLayer> currentSubLayer = new ReadOnlyObjectWrapper<>(SubLayer.PAGE);
...
//        map.put(OverviewPage.class, NavTree.Item.page(OverviewPage.NAME, OverviewPage.class));
    ...
    public void showSourceCode() {
        currentSubLayer.set(SubLayer.SOURCE_CODE);
    }
