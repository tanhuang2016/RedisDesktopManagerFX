    ...
    private void initListeners() {
        ...
        DefaultEventBus.getInstance().subscribe(ThemeEvent.class, e -> {
            if (ThemeManager.getInstance().getTheme() != null
                && model.currentSubLayerProperty().get() == MainModel.SubLayer.SOURCE_CODE) {
                showSourceCode();
            }
        });
        ...
        DefaultEventBus.getInstance().subscribe(PageEvent.class, e -> {
            if (e.getAction() == PageEvent.Action.SOURCE_CODE_ON) {
                model.showSourceCode();
            }
            if (e.getAction() == PageEvent.Action.SOURCE_CODE_OFF) {
