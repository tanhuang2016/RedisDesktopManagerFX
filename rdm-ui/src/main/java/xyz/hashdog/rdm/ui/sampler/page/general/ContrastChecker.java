...
import xyz.hashdog.rdm.ui.sampler.util.ContrastLevel;
import xyz.hashdog.rdm.ui.sampler.util.JColor;
import xyz.hashdog.rdm.ui.sampler.util.JColorUtils;
import xyz.hashdog.rdm.ui.sampler.util.PlatformUtils;

import java.util.Map;
import java.util.Objects;

import static xyz.hashdog.rdm.ui.sampler.page.general.ColorPaletteBlock.validateColorName;
import static xyz.hashdog.rdm.ui.sampler.util.ContrastLevel.getColorLuminance;
import static xyz.hashdog.rdm.ui.sampler.util.ContrastLevel.getContrastRatioOpacityAware;
import static xyz.hashdog.rdm.ui.sampler.util.JColorUtils.flattenColor;
import static xyz.hashdog.rdm.ui.sampler.util.JColorUtils.toHexWithAlpha;
...
final class ContrastChecker extends GridPane {
    ...
    public Color getFlatBgColor() {
        double[] flatBg = flattenColor(getBgBaseColor(), getBgColor());
